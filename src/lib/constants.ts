...
export const FEATURED_PRODUCTS = [
  ...
  { name: "Fiddle Leaf Fig", pot: "incl. Woven Basket", price: "$85.00", photo: "https://images.unsplash.com/photo-1612360520697-393f6b96e499?auto=format&fit=crop&w=500&q=80" },
  { name: "Snake Plant", pot: "incl. Terracotta Pot", price: "$28.00", photo: "https://images.unsplash.com/photo-1616690248297-15d6a2f357f8?auto=format&fit=crop&w=500&q=80" },
  { name: "Premium ZZ Plant", pot: "incl. Concrete Pot", price: "$42.00", photo: "https://images.unsplash.com/photo-1637967886160-fd78dc3eb495?auto=format&fit=crop&w=500&q=80" },
];
...
export const CATEGORY_IMAGES: Record<string, string> = {
  ...
  herbs: "https://images.unsplash.com/photo-1612360520697-393f6b96e499?auto=format&fit=crop&w=600&q=80",
  flowering: "https://images.unsplash.com/photo-1616690248297-15d6a2f357f8?auto=format&fit=crop&w=600&q=80",
  ferns: "https://images.unsplash.com/photo-1637967886160-fd78dc3eb495?auto=format&fit=crop&w=600&q=80",
  air_plants: "https://images.unsplash.com/photo-1545249351-ef056c0b01d4?auto=format&fit=crop&w=600&q=80",
  ...
  default: "https://images.unsplash.com/photo-1545249351-ef056c0b01d4?auto=format&fit=crop&w=600&q=80",
};

export const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1545249351-ef056c0b01d4?auto=format&fit=crop&w=400&q=80";
